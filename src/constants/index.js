...
export const HERO_CONTENT = 'I am a dynamic and innovative full-stack developer with a strong command of React and Python, dedicated to architecting scalable, high-performance web applications. With expertise in React and Next.js, I craft seamless, intuitive, and visually engaging user experiences. On the back end, I harness the power of Python (Django, FastAPI) and Node.js to build secure, efficient, and optimized APIs, integrating robust databases like MySQL and MongoDB. Passionate about problem-solving and cutting-edge technology, I thrive on delivering impact-driven digital solutions that enhance user engagement and accelerate business growth.'
